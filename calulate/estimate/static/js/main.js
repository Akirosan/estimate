...
// Функция собирает цены и колличества + новый элемент
// Отправляет чрезрез Ajax обработчику для обновления списка элементов и сохранения значений сумм и количества
// Возвращает новый список элемнтов со значениями
// Вызывается при клике на новый элемент в выпадающем списке
